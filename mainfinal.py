...
encodeur_CV1.when_rotated_clockwise = action.cv1_increase
encodeur_CV1.when_rotated_counter_clockwise = action.cv1_decrease
encodeur_CV2.when_rotated_clockwise = action.cv2_increase
encodeur_CV2.when_rotated_counter_clockwise = action.cv2_decrease
encodeur_CV3.when_rotated_clockwise = action.cv3_increase
encodeur_CV3.when_rotated_counter_clockwise = action.cv3_decrease
encodeur_CV4.when_rotated_clockwise = action.cv4_increase
encodeur_CV4.when_rotated_counter_clockwise = action.cv4_decrease
